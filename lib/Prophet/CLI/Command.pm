...
=method edit_hash hash => hashref, ordering => arrayref
...
=method edit_props arg => str, defaults => hashref, ordering => arrayref
...
=method prompt_choices question
...
=method get_cmd_and_subcmd_names [no_type => 1]
